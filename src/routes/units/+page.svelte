...
<main class="container">
	<header class="page-header">
		<h2>จัดการหน่วยสินค้า ({data.units.length} รายการ)</h2>
		<a href="/units/new" role="button" class="primary-btn">+ เพิ่มหน่วยใหม่</a>
	</header>
	...
	<article class="table-card">
		{#if data.units.length === 0}
			<p class="empty-message">ยังไม่มีข้อมูลหน่วยสินค้า</p>
		{:else}
			<table>
				<thead>
					<tr>
